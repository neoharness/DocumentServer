...
target "core" {
  ...
  cache-from = ["type=local,src=${BUILD_CACHE_ROOT}/${CACHE_NAMESPACE}/core"]
  cache-to   = ["type=local,dest=${BUILD_CACHE_ROOT}/${CACHE_NAMESPACE}/core,mode=max"]
}
...
target "core-wasm" {
  ...
  cache-from = ["type=local,src=${BUILD_CACHE_ROOT}/${CACHE_NAMESPACE}/core-wasm"]
  cache-to   = ["type=local,dest=${BUILD_CACHE_ROOT}/${CACHE_NAMESPACE}/core-wasm,mode=max"]
}
...
target "sdkjs" {
  ...
  target     = "sdkjs"
  cache-from = ["type=local,src=${BUILD_CACHE_ROOT}/${CACHE_NAMESPACE}/sdkjs"]
  cache-to   = ["type=local,dest=${BUILD_CACHE_ROOT}/${CACHE_NAMESPACE}/sdkjs,mode=max"]
  contexts = {
...
target "web-apps" {
  ...
  cache-from = ["type=local,src=${BUILD_CACHE_ROOT}/${CACHE_NAMESPACE}/web-apps"]
  cache-to   = ["type=local,dest=${BUILD_CACHE_ROOT}/${CACHE_NAMESPACE}/web-apps,mode=max"]
}
...
target "server" {
  ...
  cache-from = ["type=local,src=${BUILD_CACHE_ROOT}/${CACHE_NAMESPACE}/server"]
  cache-to   = ["type=local,dest=${BUILD_CACHE_ROOT}/${CACHE_NAMESPACE}/server,mode=max"]
  contexts = {
...
target "example" {
  ...
  cache-from = ["type=local,src=${BUILD_CACHE_ROOT}/${CACHE_NAMESPACE}/example"]
  cache-to   = ["type=local,dest=${BUILD_CACHE_ROOT}/${CACHE_NAMESPACE}/example,mode=max"]
  contexts = {
    brand-icons    = "target:brand-icons"
  }
}
...
target "bundle" {
  ...
  cache-from = ["type=local,src=${BUILD_CACHE_ROOT}/${CACHE_NAMESPACE}/bundle"]
  cache-to   = ["type=local,dest=${BUILD_CACHE_ROOT}/${CACHE_NAMESPACE}/bundle,mode=max"]
}
...
target "packages" {
  ...
  cache-from = ["type=local,src=${BUILD_CACHE_ROOT}/${CACHE_NAMESPACE}/packages"]  # reuses builder cache
}
...
target "_headless-runtime-common" {
  ...
  cache-from = ["type=local,src=${BUILD_CACHE_ROOT}/${CACHE_NAMESPACE}/office-runtime"]
  cache-to   = ["type=local,dest=${BUILD_CACHE_ROOT}/${CACHE_NAMESPACE}/office-runtime,mode=max"]
}
...
target "cluster-docs" {
  ...
  cache-from = ["type=local,src=${BUILD_CACHE_ROOT}/${CACHE_NAMESPACE}/docs"]
  cache-to   = ["type=local,dest=${BUILD_CACHE_ROOT}/${CACHE_NAMESPACE}/docs,mode=max"]
}
...
target "cluster-utils" {
  ...
  cache-from = ["type=local,src=${BUILD_CACHE_ROOT}/${CACHE_NAMESPACE}/utils"]
  cache-to   = ["type=local,dest=${BUILD_CACHE_ROOT}/${CACHE_NAMESPACE}/utils,mode=max"]
}
...
target "standalone" {
  ...
  args = {
    NHO_RELEASE_VERSION = "${NHO_RUNTIME_VERSION}"
    NHO_SOURCE_REVISION = "${NHO_SOURCE_REVISION}"
    SOURCE_DATE_EPOCH   = "${SOURCE_DATE_EPOCH}"
  }
  contexts = {
  ...
  cache-from = ["type=local,src=${BUILD_CACHE_ROOT}/${CACHE_NAMESPACE}/documentserver"]
  cache-to   = ["type=local,dest=${BUILD_CACHE_ROOT}/${CACHE_NAMESPACE}/documentserver,mode=max"]
}
...
target "develop" {
  ...
  cache-from = ["type=local,src=${BUILD_CACHE_ROOT}/${CACHE_NAMESPACE}/develop"]
  cache-to   = ["type=local,dest=${BUILD_CACHE_ROOT}/${CACHE_NAMESPACE}/develop,mode=max"]
}
